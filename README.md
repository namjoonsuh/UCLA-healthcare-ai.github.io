...
**April 19th, 2024** <br>
We are pleased to announce the Generative AI for Healthcare Workshop at UCLA. This one-day workshop is hosted by the [UCLA Department of Statistics](http://statistics.ucla.edu/) and sponsored by [UCLA College Luskin Lecture](https://www.college.ucla.edu/luskinthoughtlecture/about-the-luskin-lecture/). 
The workshop will be held at the [UCLA Luskin Conference Center](https://luskinconferencecenter.ucla.edu/hotels-near-ucla/), Legacy Room (1st floor) in Luskin Hotel.

### About
Generative AI holds profound significance for healthcare by revolutionizing various aspects of medical research, diagnostics, and patient care. Its capacity to generate realistic and diverse data allows for the creation of synthetic datasets that augment the limited availability of real-world patient information, facilitating the development and validation of robust machine learning models. In this workshop, we will discuss two main pillars in healthcare AI: “trustworthiness” and “interpretability”. Just as the ability to simulate patient scenarios and generate synthetic electronic health records enhances trustworthiness by preserving individual privacy, interpretability ensures transparent decision-making processes, a critical aspect in fostering trust and reliability within medical applications. For discussion, the workshop brings together a diverse community of generative AI researchers from various disciplines, including statistics, machine learning, and computer science, along with policymakers and industrial partners. Please join us on April 19 in the Luskin Hotel for this great event. 
